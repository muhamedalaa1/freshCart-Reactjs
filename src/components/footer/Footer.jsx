    ...
    <div className='d-flex justify-content-between align-items-center'>
      <div className="container-fluid p-0">
        ...
        <ul className='list-unstyled d-flex align-align-items-center mb-0'>
          <li className='me-3'><img src={amazonPay} alt="" /></li>
          <li className='me-3'><img src={americanExpress} alt="" /></li>
          <li className='me-3'><img src={mastercard} alt="" /></li>
          <li className='me-3'><img style={{width:"64px" , height:"64px"}} src={paypal} alt="" /></li>
        </ul>
            </div>
          </div>
          <div className="col-lg-6 col-md-12">
        ...
        <div className='bg-black text-white d-flex align-items-center rounded p-1'>
         ...
         <div className='ms-2 bg-black text-white d-flex align-items-center rounded p-1'>
